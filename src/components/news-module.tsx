...
const mockNewsSource: Omit<NewsItem, 'riskWindowMins' | 'eventType' | 'volatilityRiskScore' | 'arjunMeaning' | 'recommendedAction'>[] = Array.from({ length: 25 }, (_, i) => {
    ...
    const headlines = [
        ...
        "Ethereum's Dencun upgrade leads to lower layer-2 fees",
                                ...
                                return (
                                    <TooltipProvider key={impact}>
                                        <Tooltip>
                                            ...
                                            <TooltipContent>
                                                <p>{count} items with {impact} impact in {category}.</p>
                                            </TooltipContent>
                                        </Tooltip>
                                    </TooltipProvider>
                                );
                    ...
                    <Card className="bg-muted/30 border-border/50 sticky top-[72px] z-20">
                        <Collapsible open={isFiltersOpen} onOpenChange={setIsFiltersOpen}>
                            <CardHeader>
                                <div className="flex items-center justify-between">
                                    <CollapsibleTrigger asChild>
                                        <button className="flex items-center gap-2 flex-1 text-left outline-none focus-visible:ring-2 focus-visible:ring-ring rounded-sm">
                                    ...
                                    <Button variant="ghost" size="sm" onClick={(e) => { e.stopPropagation(); clearFilters(); }}><X className="mr-2 h-4 w-4"/>Clear all</Button>
                                </div>
                            </CardHeader>
                            <CollapsibleContent>
                                <CardContent className="space-y-6">
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            <Label className="text-xs font-semibold text-muted-foreground">Quick Filters</Label>
