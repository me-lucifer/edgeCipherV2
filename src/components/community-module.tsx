...
const initialCommunityState: CommunityState = {
    ...
    likesMap: { '1': 18, '2': 42, '3': 28, '4': 55, '5': 30 },
    savesMap: { '1': 7, '2': 20, '3': 12, '4': 30, '5': 15 },
    commentsMap: {
        '1': [{ author: "Jane D.", text: "Been there. Good on you for recognizing it and shutting it down." }],
        '2': [],
        '3': [{ author: "Alex R.", text: "This is a great reframe. My rule adherence is something I can actually control." }],
        '4': [{ author: "Maria S.", text: "That's the way! A red day sticking to the plan is better than a green day breaking rules." }],
        '5': [{ author: "Chen W.", text: "This is so important. My checklist has saved me from so many bad trades." }]
    },
    savedPostIds: [],
    officialPosts: [
